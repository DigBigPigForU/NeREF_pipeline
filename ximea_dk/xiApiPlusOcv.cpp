...
//#include <xiAPIplus/xiapiplus.h> 
	...
	// Number of bytes to commit to low level (XI_PRM_ACQ_TRANSPORT_DATA_COMMIT)
	// integer type
	int xiAPIplus_Camera::GetAcquisitionTransportDataCommit()
	{
		int val=0;
		
		CheckCamHandle("GetAcquisitionTransportDataCommit");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_ACQ_TRANSPORT_DATA_COMMIT, &val);
		CheckResult(res,"GetAcquisitionTransportDataCommit");
		return val;
	}
	int xiAPIplus_Camera::GetAcquisitionTransportDataCommit_Maximum()
	{
		int val=0;
		
		CheckCamHandle("GetAcquisitionTransportDataCommit" "_Maximum");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_ACQ_TRANSPORT_DATA_COMMIT XI_PRM_INFO_MAX, &val);
		CheckResult(res,"GetAcquisitionTransportDataCommit" "_Maximum");
		return val;
	}
	
	int xiAPIplus_Camera::GetAcquisitionTransportDataCommit_Minimum()
	{
		int val=0;
		
		CheckCamHandle("GetAcquisitionTransportDataCommit" "_Minimum");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_ACQ_TRANSPORT_DATA_COMMIT XI_PRM_INFO_MIN, &val);
		CheckResult(res,"GetAcquisitionTransportDataCommit" "_Minimum");
		return val;
	}

	int xiAPIplus_Camera::GetAcquisitionTransportDataCommit_Increment()
	{
		int val=0;
		
		CheckCamHandle("GetAcquisitionTransportDataCommit" "_Increment");
		
		XI_RETURN res=xiGetParamInt(camera_handle, XI_PRM_ACQ_TRANSPORT_DATA_COMMIT XI_PRM_INFO_INCREMENT, &val);
		CheckResult(res,"GetAcquisitionTransportDataCommit" "_Increment");
		return val;
	}
	
	void xiAPIplus_Camera::SetAcquisitionTransportDataCommit(int AcquisitionTransportDataCommit)
	{
		
		CheckCamHandleInt("SetAcquisitionTransportDataCommit",AcquisitionTransportDataCommit);
		
		XI_RETURN res=xiSetParamInt(camera_handle, XI_PRM_ACQ_TRANSPORT_DATA_COMMIT, AcquisitionTransportDataCommit);
		CheckResult(res,"SetAcquisitionTransportDataCommit");
	}
