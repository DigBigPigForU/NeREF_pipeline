...
// Generated for xiAPI version 0.0.6299
...
public:
	...
	int GetAcquisitionTransportDataCommit();
	int GetAcquisitionTransportDataCommit_Maximum();
	int GetAcquisitionTransportDataCommit_Minimum();
	int GetAcquisitionTransportDataCommit_Increment();
	void SetAcquisitionTransportDataCommit(int AcquisitionTransportDataCommit);
