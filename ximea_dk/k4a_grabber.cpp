...
k4a::image pcl::KinectAzureDKGrabber::getColorImage()
{
    return colorImage;
}
k4a::image pcl::KinectAzureDKGrabber::getDepthImage()
{
    return depthImage;
}
k4a::image pcl::KinectAzureDKGrabber::getInfraredImage()
{
    return infraredImage;
}
pcl::PointCloud<pcl::PointXYZRGBA> pcl::KinectAzureDKGrabber::getPointCloud()
{
    return pc;
}
